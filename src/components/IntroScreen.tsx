...
export const IntroScreen: React.FC<IntroScreenProps> = ({ onStart, onToggleSidebar, userProfiles }) => {
  ...
  const AVATAR_OPTIONS = [
    "https://lh3.googleusercontent.com/u/0/d/1htMRsK2k7pDJQtmfNA8dRqsTZbkLBIKh"
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onStart({
      name: name.trim(),
      appearance: appearance.trim() || "Sở hữu vẻ đẹp sắc sảo. Làn da trắng sứ mịn màng không tì vết. Đôi môi căng mọng, thường tô son đỏ lạnh hoặc hồng đào. Dáng người mềm mại, mỏng manh.",
      personality: personality.trim(),
      age: 25,
      background: "Cô gái sinh ra và lớn lên ở miền quê, là thanh mai trúc mã và cũng là tình đầu năm 18 tuổi của Cao Kiến Thành. Đạt bằng xuất sắc chuyên ngành Marketing, vươn lên từ một nhân viên chi nhánh tỉnh lẻ đặng giành suất thuyên chuyển lên Hội sở chính."
    }, selectedAvatar);
  };
