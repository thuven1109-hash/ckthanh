...
const STORAGE_KEY = "cao_kien_thanh_sessions";
...
const MUSIC_STORAGE = "cao_kien_thanh_music";
const USER_PROFILES_STORAGE = "cao_kien_thanh_user_profiles";
  ...
  const handleGenerateDiary = async () => {
    ...
    try {
      ...
      const diaryPrompt = `
        ...
        4. Sử dụng văn văn phong hiện đại, pha lẫn khẩu ngữ Sài Gòn, sâu sắc và đầy tâm trạng.
